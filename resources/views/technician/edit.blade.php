                ...
                <div class="card-body p-5">
                    <div class="mb-5">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-4">Update Technician</h5>
                        ...
                        <form action="{{ route('technician.update', $technician->id) }}" method="POST">
                            ...
                            <div class="form-group col-12 col-md-6 mb-3">
                                ...
                                <input type="text" value="{{ (old('name')) ? old('name') : $technician->name }}" class="form-control @error('name') is-invalid @enderror" id="name" name="name">
                                @error('name')
                            ...
                            <div class="form-group col-12 col-md-6 mb-3">
                                ...
                                <input type="number" value="{{ (old('matric_id')) ? old('matric_id') : $technician->matric_id }}" class="form-control @error('matric_id') is-invalid @enderror" id="matric_id" name="matric_id">
                                @error('matric_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-12 col-md-6 mb-3">
                                ...
                                <input type="email" value="{{ (old('email')) ? old('email') : $technician->email }}" class="form-control @error('email') is-invalid @enderror" id="email" name="email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-12 col-md-6 mb-4">
                                ...
                                <input type="tel" value="{{ (old('phone_number')) ? old('phone_number') : $technician->phone_number }}" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number">
                                @error('phone_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mt-5">
                        ...
                        <form action="{{ route('technician.update-password', $technician->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group col-12 col-md-6 mb-3">
